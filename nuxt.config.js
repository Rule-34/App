...
export default {
  ...
  sitemap: {
    ...
    routes: [
      ...
      // SEO
      { url: '/?domain=rule34.xxx&page=0&tags=pokemon', priority: 0.8 },
      {
        url: '/?domain=rule34.xxx&page=0&tags=friday_night_funkin',
        priority: 0.8,
      },
      { url: '/?domain=rule34.xxx&page=0&tags=fortnite', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=brawl_stars', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=naruto', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=animated', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=naruto', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=furry', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=samsung', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=sex', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=star_wars', priority: 0.8 },
      {
        url: '/?domain=rule34.paheal.net&page=0&tags=Damon_Salvatore',
        priority: 0.8,
      },
      { url: '/?domain=rule34.xxx&page=0&tags=gay', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=comic', priority: 0.8 },
      {
        url: '/?domain=rule34.xxx&page=0&tags=my_hero_academia',
        priority: 0.8,
      },
      { url: '/?domain=rule34.xxx&page=0&tags=genshin_impact', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=among_us', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=zootopia', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=sakura_haruno', priority: 0.8 },
      {
        url: "/?domain=rule34.xxx&page=0&tags=five_nights_at_freddy's",
        priority: 0.8,
      },
      { url: '/?domain=rule34.xxx&page=0&tags=ankha', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=deltarune', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=animal_crossing', priority: 0.8 },
      {
        url: '/?domain=rule34.xxx&page=0&tags=spider-man_(series)',
        priority: 0.8,
      },
      { url: '/?domain=rule34.xxx&page=0&tags=roblox', priority: 0.8 },
      { url: '/?domain=rule34.xxx&page=0&tags=apex_legends', priority: 0.8 },
    ],
  },
