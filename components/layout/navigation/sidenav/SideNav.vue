	...
	<aside class="fixed z-40 flex min-h-screen w-full md:flex-row">
		<div class="flex flex-col border-darkGray-100 bg-darkGray-300 md:border-r">
			...
			<div class="relative h-full overflow-hidden">
				...
				<!-- Text on image -->
				<div class="absolute bottom-0 left-0 p-3 transition-colors duration-300">
					<h1 class="text-lg font-semibold text-gray-200">Rule 34 App</h1>
					<h3 class="text-gray-300">Browse popular Hentai</h3>
				</div>
			</div>
