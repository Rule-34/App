<template>
  <button
    ...
    class='focus-visible:focus-util relative flex h-10 w-10 items-center justify-center rounded-full border-0 bg-gradient-to-t from-primary-400 to-accent-400 p-3 shadow md:h-12 md:w-12'
    title='Search'
    type='menu'
    @click='toggleSearch'
  >
