<template>
  ...
  <div class="post-container">
    ...
    <div
      ...
      class="flex flex-wrap overflow-hidden text-sm"
    >
      <!-- Tags -->
      <div v-if="post.tags && isActive" class="w-full md:w-11/12 tag-container">
        <a v-for="tag in post.tags" :key="post[tag]" class="tag" v-text="tag" />
      </div>
      <!-- Source -->
      <div
        v-if="post.source"
