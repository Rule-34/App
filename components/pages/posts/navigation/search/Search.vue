        ...
        >
          ...
          >
            ...
            <div class='absolute inset-x-0 bottom-0 flex'>
              <button
                class='focus-visible:focus-util focus-visible:ring-white w-full bg-gradient-to-r from-accent-400 to-primary-400 px-4 py-2 text-center text-lg font-medium tracking-wide text-black ring-inset'
                type='submit'
              >
                Apply tags
              </button>
