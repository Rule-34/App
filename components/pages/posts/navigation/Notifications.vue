<template>
	<div>
		...
		<button
			...
			class="border-util focus-visible:focus-util flex rounded-full bg-darkGray-300 p-1"
			type="button"
				...
				<div class="absolute inset-0 overflow-hidden">
					...
					>
						<div class="w-screen max-w-md">
							<div class="flex h-full flex-col overflow-y-scroll bg-darkGray-700 py-6">
								<div class="px-4 sm:px-6">
									<div class="flex items-start justify-between">
										...
										<div class="ml-3 flex h-7 items-center">
											<button
												class="border-util focus-visible:focus-util rounded-full bg-darkGray-300 p-1 text-white"
												@click="toggleNotifications"
											>
...
export default {
	...
	computed: {
		...mapGetters('notifications', ['getNotifications', 'hasNotificationsBeenFetched', 'isThereANewNotification'])
	},
