    ...
    <Teleport to="body">
      ...
      >
        <HeadlessListboxOptions
          ...
          class="bg-base-1000 ring-base-0/20 z-50 max-h-[23rem] w-full max-w-sm overflow-auto rounded-md py-1 ring-1 focus:outline-hidden sm:text-sm"
        >
          <!-- Options -->
          ...
          <div class="hover:hover-text-util hover:hover-bg-util group flex items-center px-3 py-2">
            <PlusIcon
              aria-hidden="true"
              class="group-hover:hover-text-util h-5 w-5 rounded-sm"
            />
