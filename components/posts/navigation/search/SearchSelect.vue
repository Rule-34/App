  ...
  >
    ...
    <div class="relative">
      ...
      <div ref="container">
        ...
        >
          <ListboxOptions
            class="absolute right-0 z-10 mt-2 w-44 origin-top-right divide-y divide-base-0/20 overflow-hidden rounded-md bg-base-1000 shadow-lg ring-1 ring-inset ring-base-0/20 focus:outline-none"
          >
            <ListboxOption
