<script lang="ts" setup>
  ...
  let dialogReadyTimer: number | undefined
    ...
    >
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <HeadlessDialogPanel
              class="relative w-full transform overflow-hidden rounded-lg bg-base-1000 px-4 pt-5 pb-4 text-left shadow-xl ring-1 ring-base-0/10 transition-all sm:my-8 sm:max-w-2xl sm:p-6"
            >
              <component
                :is="dialog?.component"
