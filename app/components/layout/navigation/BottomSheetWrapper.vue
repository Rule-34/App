          ...
          >
            <HeadlessDialogPanel class="relative mx-auto flex max-h-[90vh] w-full max-w-2xl flex-1 self-end">
              ...
              <div class="flex grow flex-col gap-2 rounded-t-xl bg-base-1000 ring-1 ring-base-0/20">
                ...
                <button
                  type="button"
                  class="mx-auto inline-flex w-full items-center justify-center border-t border-base-0/20 px-3 py-2 text-base hover:hover-bg-util hover:hover-text-util focus-visible:focus-outline-util"
                  @click="isOpen = false"
                >
                  {{ $t('common.close') }}
                </button>
