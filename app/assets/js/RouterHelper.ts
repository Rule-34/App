...
export function generatePostsRoute(
  ...
  const route: RouteLocationRaw & { query: LocationQueryRaw } = {
    path,
    query: {}
  }
...
export function getSinglePositiveTagQueryValue(value: string | string[] | null | (string | null)[] | undefined) {
  ...
  if (tagPrefix && facetedTagPrefixes.has(tagPrefix)) {
    return undefined
  }
...
export function getSingleRouteParam(param: string | string[] | undefined) {
