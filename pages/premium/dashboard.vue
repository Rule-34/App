...
<template>
  ...
  <main class="container mx-auto max-w-3xl flex-1 px-4 py-4 sm:px-6 lg:px-8">
    ...
    <!-- Premium Features -->
    <section class="mt-8">
      <h2 class="text-base-content-highlight mb-4 text-xl font-bold">{{ $t('pages.premium.dashboard.featuresTitle') }}</h2>
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        >
          <div class="mb-2 flex items-center gap-2">
            ...
            <h3 class="text-base-content-highlight text-lg font-bold tracking-tight">{{ $t('pages.premium.dashboard.discordRoleName') }}</h3>
          </div>
    ...
    <section class="mt-8">
      ...
      >
        ...
        <div>
          <h2 class="text-base-content-highlight text-lg font-bold tracking-tight">{{ $t('pages.premium.dashboard.feedbackTitle') }}</h2>
          <p class="text-sm">
